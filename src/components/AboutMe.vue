<template>
  <section id="about-me">
    ...
    <v-container class="text-center">
      <h2 class="display-2 font-weight-bold mb-3">Kim jestem?</h2>
      ...
      <div class="py-12"></div>
      <h2 class="display-2 font-weight-bold mb-3">Zamówienia możesz składać na</h2>
    </v-container>
  </section>
</template>
